...
<nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <div class="row">
                    <a class="btn" href="form_presensi_pengajar.php"><img src="assets/img/share.png" title="Presensi"></a>
                </div>
                </ul>
                <form class="d-flex">
                    <div class="text-left">
                        <a class="btn" href="form_presensi_pengajar.php"><img src="assets/img/pen_3.png"></a>
                        <a class="btn" href="form_presensi_pengajar.php"><img src="assets/img/users.png"></a>
                    </div>
                </form>
            </div>
        </div>
