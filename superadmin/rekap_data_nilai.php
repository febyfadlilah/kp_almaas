                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Data Nilai Jamaah</h3>
                                </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarScroll">
                                        <form class="model2 d-flex" method="post">
                                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll mt-2" style="--bs-scroll-height: 100px;">
                                                ...
                                                <li class="model"><button class="btn btn-success" name ="kirim" type="submit">Search</button></li>
                                            </ul>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            $no = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <p data-placement="top" data-toggle="tooltip" title="Detail"><a href="data_nilai.php?id_jamaah=<?=$baris['id_jamaah']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" >Detail</button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
