                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <?php
                                                ...
                                                <?php
                                                    ...
                                                    <td>
                                                    <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="hapus_presensi.php?id_presensi=<?=$baris['id_presensi']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-trash"></span></button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
