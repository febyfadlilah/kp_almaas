                                ...
                                <div class="container-fluid">
                                    <div class="collapse navbar-collapse" id="navbarScroll">
                                        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                                            <a target="_blank" href="cetak_data_tamu_belum.php" class="btn btn-success model3" name="excel">Export Excel</a>
                                        </ul>
                                        <form class="model2 d-flex" method="post">
                                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll mt-2" style="--bs-scroll-height: 100px;">
                                                <li class="model"><input class="form-control" name="key" type="search" placeholder="Search" aria-label="Search"></li>
                                    ...
                                    if(isset($_POST['submit'])){
                                        $key = $_POST['key'];
                                        $hasil = mysqli_query($koneksi, "SELECT * FROM tamu where status_kunjungan ='belum' AND nama_lengkap LIKE '%$key%' ");
                                    } else {
                                        $hasil = mysqli_query($koneksi, "SELECT * FROM tamu where status_kunjungan ='belum'");
                                    }
                                    ?>
                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="edit_status_tamu.php?id_tamu=<?=$baris['id_tamu']?>" method="post">
                                                        <td><p data-placement="top" data-toggle="tooltip"><button name="sudah" class="btn btn-success btn-xs">Sudah</button></p></td>
                                                    </form>
                                                </tr>
                                                <?php } ?>
                                            </tbody> 
...
<?php
    ...
    if (isset($_POST['sudah'])){
        ...
        status_kunjungan = $status_kunjungan WHERE id_tamu=$id"; 
