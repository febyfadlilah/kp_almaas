                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="hapus_data_pengajar.php?id_pengajar=<?=$baris['id_pengajar']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit"><span class="glyphicon glyphicon-trash"></span></button></a></p>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
