                                            ...
                                            $no = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p data-placement="top" data-toggle="tooltip" title="delete"><a href="hapus_jadwal_kelas.php?id_jadwal=<?=$baris['id_jadwal']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-trash"></span></button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
