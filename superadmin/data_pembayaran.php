                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            $no = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <p data-placement="top" data-toggle="tooltip" title="Detail"><a href="show_detail_pembayaran.php?id_jamaah=<?=$baris['id_jamaah']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" >Detail</button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
