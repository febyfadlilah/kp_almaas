                        ...
                        <div id="page-content">
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Data Rekap Evaluasi</h3>
                                </div>
                                        ...
                                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            $no = 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <p data-placement="top" data-toggle="tooltip" title="Detail"><a href="data_evaluasi.php?id_jamaah=<?=$baris['id_jamaah']?>"><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" >Detail</button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
