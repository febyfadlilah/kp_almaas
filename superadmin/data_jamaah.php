                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="edit_data_jamaah.php?id_jamaah=<?=$baris['id_jamaah']?>">
                                                            ...
                                                            <p data-placement="top" data-toggle="tooltip" title="Edit"><a href="hapus_data_jamaah.php?id_jamaah=<?=$baris['id_jamaah']?>">
                                                            <button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-trash"></span></button></a></p>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>
